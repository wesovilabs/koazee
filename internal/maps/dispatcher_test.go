...
func Test_mapStringToString(t *testing.T) {
	...
	fn := func(element string) string { return element }
	...
	for index := range output.([]string) {
		assert.Equal(t, utils.ArrayString[index], output.([]string)[index])
	}
}
...
func Test_mapPtrStringToString(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]string) {
		assert.Equal(t, *utils.ArrayStringPtr[index], output.([]string)[index])
	}
}
...
func Test_mapStringToBool(t *testing.T) {
	...
	fn := func(element bool) bool { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayBool), fn, info)
	assert.True(t, found)
	for index := range output.([]bool) {
		assert.Equal(t, utils.ArrayBool[index], output.([]bool)[index])
	}
}
...
func Test_mapPtrStringToBool(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]bool) {
		assert.Equal(t, *utils.ArrayBoolPtr[index], output.([]bool)[index])
	}
}
...
func Test_mapStringToInt(t *testing.T) {
	...
	fn := func(element int) int { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayInt), fn, info)
	assert.True(t, found)
	for index := range output.([]int) {
		assert.Equal(t, utils.ArrayInt[index], output.([]int)[index])
	}
}
...
func Test_mapPtrStringToInt(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]int) {
		assert.Equal(t, *utils.ArrayIntPtr[index], output.([]int)[index])
	}
}
...
func Test_mapStringToInt8(t *testing.T) {
	...
	fn := func(element int8) int8 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayInt8), fn, info)
	assert.True(t, found)
	for index := range output.([]int8) {
		assert.Equal(t, utils.ArrayInt8[index], output.([]int8)[index])
	}
}
...
func Test_mapPtrStringToInt8(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]int8) {
		assert.Equal(t, *utils.ArrayInt8Ptr[index], output.([]int8)[index])
	}
}
...
func Test_mapStringToInt16(t *testing.T) {
	...
	fn := func(element int16) int16 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayInt16), fn, info)
	assert.True(t, found)
	for index := range output.([]int16) {
		assert.Equal(t, utils.ArrayInt16[index], output.([]int16)[index])
	}
}
...
func Test_mapPtrStringToInt16(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]int16) {
		assert.Equal(t, *utils.ArrayInt16Ptr[index], output.([]int16)[index])
	}
}
...
func Test_mapStringToInt32(t *testing.T) {
	...
	fn := func(element int32) int32 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayInt32), fn, info)
	assert.True(t, found)
	for index := range output.([]int32) {
		assert.Equal(t, utils.ArrayInt32[index], output.([]int32)[index])
	}
}
...
func Test_mapPtrStringToInt32(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]int32) {
		assert.Equal(t, *utils.ArrayInt32Ptr[index], output.([]int32)[index])
	}
}
...
func Test_mapStringToInt64(t *testing.T) {
	...
	fn := func(element int64) int64 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayInt64), fn, info)
	assert.True(t, found)
	for index := range output.([]int64) {
		assert.Equal(t, utils.ArrayInt64[index], output.([]int64)[index])
	}
}
...
func Test_mapPtrStringToInt64(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]int64) {
		assert.Equal(t, *utils.ArrayInt64Ptr[index], output.([]int64)[index])
	}
}
...
func Test_mapStringToUint(t *testing.T) {
	...
	fn := func(element uint) uint { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayUint), fn, info)
	assert.True(t, found)
	for index := range output.([]uint) {
		assert.Equal(t, utils.ArrayUint[index], output.([]uint)[index])
	}
}
...
func Test_mapPtrStringToUint(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]uint) {
		assert.Equal(t, *utils.ArrayUintPtr[index], output.([]uint)[index])
	}
}
...
func Test_mapStringToUint8(t *testing.T) {
	...
	fn := func(element uint8) uint8 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayUint8), fn, info)
	assert.True(t, found)
	for index := range output.([]uint8) {
		assert.Equal(t, utils.ArrayUint8[index], output.([]uint8)[index])
	}
}
...
func Test_mapPtrStringToUint8(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]uint8) {
		assert.Equal(t, *utils.ArrayUint8Ptr[index], output.([]uint8)[index])
	}
}
...
func Test_mapStringToUint16(t *testing.T) {
	...
	fn := func(element uint16) uint16 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayUint16), fn, info)
	assert.True(t, found)
	for index := range output.([]uint16) {
		assert.Equal(t, utils.ArrayUint16[index], output.([]uint16)[index])
	}
}
...
func Test_mapPtrStringToUint16(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]uint16) {
		assert.Equal(t, *utils.ArrayUint16Ptr[index], output.([]uint16)[index])
	}
}
...
func Test_mapStringToUint32(t *testing.T) {
	...
	fn := func(element uint32) uint32 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayUint32), fn, info)
	assert.True(t, found)
	for index := range output.([]uint32) {
		assert.Equal(t, utils.ArrayUint32[index], output.([]uint32)[index])
	}
}
...
func Test_mapPtrStringToUint32(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]uint32) {
		assert.Equal(t, *utils.ArrayUint32Ptr[index], output.([]uint32)[index])
	}
}
...
func Test_mapStringToUint64(t *testing.T) {
	...
	fn := func(element uint64) uint64 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayUint64), fn, info)
	assert.True(t, found)
	for index := range output.([]uint64) {
		assert.Equal(t, utils.ArrayUint64[index], output.([]uint64)[index])
	}
}
...
func Test_mapPtrStringToUint64(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]uint64) {
		assert.Equal(t, *utils.ArrayUint64Ptr[index], output.([]uint64)[index])
	}
}
...
func Test_mapStringToFloat32(t *testing.T) {
	...
	fn := func(element float32) float32 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayFloat32), fn, info)
	assert.True(t, found)
	for index := range output.([]float32) {
		assert.Equal(t, utils.ArrayFloat32[index], output.([]float32)[index])
	}
}
...
func Test_mapPtrStringToFloat32(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]float32) {
		assert.Equal(t, *utils.ArrayFloat32Ptr[index], output.([]float32)[index])
	}
}
...
func Test_mapStringToFloat64(t *testing.T) {
	...
	fn := func(element float64) float64 { return element }
	info := &mapInfo{fnInputType: inputType, fnOutputType: outputType}
	found, output := dispatch(reflect.ValueOf(utils.ArrayFloat64), fn, info)
	assert.True(t, found)
	for index := range output.([]float64) {
		assert.Equal(t, utils.ArrayFloat64[index], output.([]float64)[index])
	}
}
...
func Test_mapPtrStringToFloat64(t *testing.T) {
	...
	assert.True(t, found)
	for index := range output.([]float64) {
		assert.Equal(t, *utils.ArrayFloat64Ptr[index], output.([]float64)[index])
	}
}
